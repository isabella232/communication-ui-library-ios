...
typedef NS_ENUM(NSInteger, ACSHandleType)
{
    ...
    ACSHandleTypeDominantSpeakersCallFeature = 6
...
@property(nonnull) ACSCallKitRemoteInfo* callKitRemoteInfo;
...
-(void)createCallAgentWithCallKitOptions:(CommunicationTokenCredential * _Nonnull) userCredential
                        callAgentOptions:(ACSCallAgentOptions* _Nullable) callAgentOptions
                          callKitOptions:(ACSCallKitOptions* _Nullable) callKitOptions
                   withCompletionHandler:(void (^ _Nonnull)(ACSCallAgent* _Nullable clientAgent,
                                                            NSError* _Nullable error))completionHandler NS_SWIFT_NAME( createCallAgent(userCredential:options:callKitOptions:completionHandler:));

+(void)reportToCallKit:(ACSPushNotificationInfo* _Nonnull)payload
        callKitOptions:(ACSCallKitOptions* _Nonnull) callKitOptions
 withCompletionHandler:(void (^ _Nonnull)(NSError* _Nullable error))completionHandler NS_SWIFT_NAME( reportToCallKit(with:callKitOptions:completionHandler:));
 ...
 */
@property(nonatomic, assign, nullable) id<ACSDominantSpeakersCallFeatureDelegate> delegate;
